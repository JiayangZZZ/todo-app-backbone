...
var out='<!-- template for creating todo --><div class="create-title"><input name="title" class="input-todo-title" type="text" placeholder="Title here"></input></div><div class="create-description"><textarea name="description" class="input-todo-description" type="text" placeholder="Write some details about this!"></textarea></div>';return out;
};
...
var out='<!-- template for single todo --><div class="title">'+(it.title)+'</div><div class="description">'+(it.description)+'</div><div class="delete"><a href="http://zhangjiayang.dev.p1staff.com:3300/create" class="delete-button"><p class="delete-button-text">DELETE</p></a></div><div class="back"><a href="http://zhangjiayang.dev.p1staff.com:3300/create" class="back-button"><p class="back-button-text">BACK</p></a></div>';return out;
};
return tmpl;});
