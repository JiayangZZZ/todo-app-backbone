...
var out='<!DOCTYPE html><html><head><meta charset="UTF-8"><meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"><title>TODO APP</title><link href="../public/styles/build/styles.css" rel="stylesheet" type="text/css"></head><body><section class="header">'+(it.header)+'</section><section class="body"><!-- '+(it.body)+' --><div class="body-container"></div></section><script data-main="/scripts/main" src="/scripts/modules/vendor/requirejs/require.js"></script></body></html>';return out;
};
  tmpl['itemTemplate']=function anonymous(it) {
var out='<li class="todo-list-item" id="'+(it.id)+'"><a href="http://zhangjiayang.dev.p1staff.com:3300/todos/'+(it.id)+'"><label>'+(it.title)+'</label></a></li>';return out;
};
