...
var out='<!--contaienr--><div class="body-container"><div class="create"><input id="new-todo" placeholder="What needs to be done?"></div><div id="container">loading...</div><ul class="todo-list">';var arr1=it.todos;if(arr1){var todo,index=-1,l1=arr1.length-1;while(index<l1){todo=arr1[index+=1];out+='<li class="todo-list-item">'+(todo.title)+'</li>';} } out+='</ul></div>';return out;
};
